...
docker build -t cb-wavelength-demo-api-cloud . -f Dockerfile.cloud
docker run -d --network demo -p 9000:80 --name cb-demo-cloud cb-wavelength-demo-api-cloud
...
docker run -d --network demo -p 9001:80 --name cb-demo-wavelength cb-wavelength-demo-api-wavelength
